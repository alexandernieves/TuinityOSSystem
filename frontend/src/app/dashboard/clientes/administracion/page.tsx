    ...
    return (
        <div className="p-6 md:p-8 space-y-6 bg-bg-base min-h-screen">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-text-primary tracking-tight">Administración de Clientes</h1>
                    <p className="text-text-secondary mt-1 font-light">Gestiona y administra tu base de datos de clientes.</p>
                </div>
                <Button
                    className="bg-brand-accent text-brand-primary font-medium"
                    startContent={<Plus size={18} />}
                    onPress={() => router.push('/dashboard/clientes/administracion/nuevo')}
                >
                    Nuevo Cliente
                </Button>
            </div>
                                            ...
                                            <TableCell>
                                                <div className="flex items-center justify-center gap-2">
                                                    ...
                                                    <Button
                                                        ...
                                                        onPress={() => router.push(`/dashboard/clientes/administracion/nuevo?id=${customer.id}`)}
                                                    >
                                                        <Edit size={18} />
                                                    </Button>
                                                </div>
