...
export default function ImportCostosPage() {
    ...
    const downloadTemplate = () => {
        ...
        XLSX.writeFile(wb, 'Plantilla_Costos_Tuinity.xlsx');
    };
                                    ...
                                    <div className="bg-bg-alt/50 p-6 flex items-center justify-between">
                                        <div className="flex items-start gap-4 text-text-secondary">
                                            ...
                                            <p className="text-xs leading-relaxed max-w-lg">
                                                Hemos detectado las columnas automáticamente. Los productos con la misma <strong>Referencia</strong> actualizarán su Costo CIF / FOB.
                                            </p>
                                        </div>
                                        <Button
                                            variant="primary"
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        <div className="bg-brand-primary/5 border border-brand-primary/10 rounded-3xl p-8">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {['Referencia', 'Descripcion', 'Costo_CIF', 'Costo_FOB'].map(c => (
