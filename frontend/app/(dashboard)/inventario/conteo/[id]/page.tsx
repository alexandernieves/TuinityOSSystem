            ...
            <div className="relative flex-1">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative h-64 w-64">
                  ...
                  <div className="animate-scan absolute left-0 right-0 top-1/2 h-0.5 bg-blue-500" />
                </div>
              </div>
            </div>
        ...
        <DialogContent className="max-w-md">
          {selectedLine && (
            <>
              <DialogHeader>
                <DialogTitle>
                  <div>
                    ...
                    <p className="text-sm text-gray-500 font-normal">{selectedLine.productDescription}</p>
                  </div>
                </DialogTitle>
              </DialogHeader>
              <div className="py-6">
                ...
                <div className="mt-4 flex justify-center">
                  <Button
                    variant="ghost"
                    onClick={() => setCountedQty(selectedLine.systemQty)}
                    className="flex items-center gap-2"
                  >
              ...
              <DialogFooter>
                <Button variant="ghost" onClick={() => setSelectedLine(null)}>
                  Cancelar
                </Button>
                <Button
            ...
            <DialogTitle>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 font-normal">Resumen del conteo</p>
                </div>
              </div>
            </DialogTitle>
          </DialogHeader>
                ...
                <table className="w-full">
                  <thead className="sticky top-0 bg-gray-50">
                    <tr>
                      ...
                      <th className="px-3 py-2 text-right text-xs font-medium text-gray-500">Sistema</th>
                      <th className="px-3 py-2 text-right text-xs font-medium text-gray-500">Contado</th>
                      <th className="px-3 py-2 text-right text-xs font-medium text-gray-500">Dif.</th>
                    </tr>
                  </thead>
                      ...
                      .map((line) => (
                        <tr key={line.id}>
                          <td className="px-3 py-2">
                            <p className="text-xs font-medium text-gray-900">{line.productReference}</p>
                          </td>
                          <td className="px-3 py-2 text-right text-xs text-gray-600">{line.systemQty}</td>
                          <td className="px-3 py-2 text-right text-xs text-gray-600">{line.countedQty}</td>
                          <td className="px-3 py-2 text-right">
                            <span className={cn('text-xs font-medium', line.difference! > 0 ? 'text-blue-600' : 'text-red-600')}>
