        ...
        for (let i = 0; i < invoicesPerDay; i++) {
            ...
            if (invoice.status !== 'CANCELLED') {
                ...
                const paymentData = {
                    ...
                    status: 'COMPLETED',
                    paidAt: new Date(invoiceDate.getTime() + randomInt(0, 3600000)),
                    createdAt: invoiceDate
                };
            ...
            if (Math.random() < 0.1 && invoice.status === 'PAID') {
                ...
                const returnData = {
                    ...
                    status: 'PROCESSED',
                    createdAt: new Date(invoiceDate.getTime() + randomInt(3600000, 86400000))
                };
...
//# sourceMappingURL=seed-pos-data.js.map