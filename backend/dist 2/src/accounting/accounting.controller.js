...
let AccountingController = class AccountingController {
    ...
    async getProfitAndLoss(start, end) {
        const { tenantId } = this.getContext();
        return this.service.getProfitAndLoss(tenantId, new Date(start), new Date(end));
    }
...
__decorate([
    (0, common_1.Post)('init-coa'),
    (0, permissions_decorator_1.RequirePermissions)(permission_key_enum_1.PermissionKey.MANAGE_TENANT),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AccountingController.prototype, "initCOA", null);
__decorate([
...
__decorate([
    (0, common_1.Get)('reports/p-and-l'),
