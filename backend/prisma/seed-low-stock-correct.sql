...
-- Insert Test Products with Low Stock for Admin Evolution
-- Tenant: a143cfdd-f7ba-431c-9653-1f8d2973b588
-- Branch: 530dd7da-e84d-484f-963b-e19c78ca06f9
...
DECLARE 
    ...
    product_id_2 text;
    product_id_3 text;
    tenant_id text := 'a143cfdd-f7ba-431c-9653-1f8d2973b588';
    branch_id text := '530dd7da-e84d-484f-963b-e19c78ca06f9';
BEGIN
    -- Product 1
    ...
    VALUES (gen_random_uuid()::text, tenant_id, product_id_1, '770123456011', NOW(), true, 'EAN13');
    ...
    INSERT INTO "ProductBarcode" (id, "tenantId", "productId", barcode, "createdAt", "isDefault", "type")
    VALUES (gen_random_uuid()::text, tenant_id, product_id_2, '770123456012', NOW(), true, 'EAN13');
    ...
    INSERT INTO "ProductBarcode" (id, "tenantId", "productId", barcode, "createdAt", "isDefault", "type")
    VALUES (gen_random_uuid()::text, tenant_id, product_id_3, '770123456013', NOW(), true, 'EAN13');
