...
// Explicitly pass empty options to satisfy the constructor check or add log options
...
async function main() {
    ...
    // ... rest is the same, just logging here for brevity in thought but I will write full
    ...
    const categoriesData = [
        'WHISKY', 'VODKA', 'TEQUILA', 'CHIPS', 'RUM', 'GIN', 'WINE', 'BEER', 'COGNAC', 'LIQUEUR'
    ];
